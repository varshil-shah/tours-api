...
var displayMap = function displayMap(locations) {
  var mapboxKey = document.getElementById('key').dataset.apikey;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(type, data) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            path = type === 'data' ? '/api/v1/users/update-me' : '/api/v1/users/update-my-password';
            _context.prev = 1;
            _context.next = 4;
            return axios({
              method: 'PATCH',
...
var stripe = Stripe('pk_test_51LnfVgSFERdMDNf1YcXkXuZfB63DxwsiwtEZkVdxC833txxmbHll0U4ddcc7FKxCMxp3SwYnq0OXXzATAX2zLPrs00uqh9HV4z');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return axios("http://localhost:3000/api/v1/bookings/checkout-session/".concat(tourId));

          case 3:
            session = _context.sent;
            console.log(session); // Create checkout form and charge from credit card
